...
export default function Officers() {
  ...
  useEffect(() => {
    if (selectedState) fetchAIExperts();
  }, [selectedState]);
        ...
        <div className="relative bg-gradient-to-r from-teal-600 via-emerald-600 to-green-600 rounded-3xl p-8 mb-8 overflow-hidden shadow-xl shadow-teal-600/20">
          ...
          <div className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
              ...
              <p className="text-emerald-100 text-lg">
                Connect with authentic agricultural experts & officers — powered by 🤖 AI
                {selectedState && (
          ...
          <div className="relative z-10 grid grid-cols-3 gap-4 mt-6">
            ...
            <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-4 text-center border border-white/30 ring-2 ring-white/20">
              ...
              <div className="text-emerald-100 text-sm font-bold">AI-Powered</div>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div className="flex items-end">
              <button onClick={fetchAIExperts} disabled={!selectedState || loading}
                ...
                {loading ? '⏳ Fetching from AI...' : '🤖 Fetch Experts from AI'}
              </button>
            </div>
          </div>
          {expertSource === 'gemini_ai' && officers.length > 0 && (
            <div className="mt-3 flex items-center gap-2 text-xs font-bold text-purple-600 bg-purple-50 px-3 py-1.5 rounded-lg border border-purple-200 w-fit">
              🤖 Experts fetched live from Gemini AI for {selectedState}
            </div>
          )}
        </div>
          ...
          <div style={{ animation: 'slideUp 0.4s ease-out' }}>
            {!selectedState ? (
              <div className="text-center p-16 bg-white rounded-3xl border-2 border-dashed border-teal-200">
                ...
                <p className="text-gray-500">Choose your state above to fetch authentic agricultural experts from AI</p>
              </div>
            ) : loading ? (
              <div className="flex flex-col items-center justify-center p-16">
                <div className="w-16 h-16 border-4 border-purple-500 border-t-transparent rounded-full animate-spin mb-4"></div>
                <p className="text-gray-600 font-bold">🤖 AI is fetching authentic experts for {selectedState}...</p>
              ...
              <div className="text-center p-16 bg-white rounded-3xl border-2 border-dashed border-gray-200">
                ...
                <p className="text-gray-500">Try clicking "Fetch Experts from AI" again</p>
              </div>
            ) : (
                    ...
                    <div className="p-6">
                      ...
                      {officer.notable_work && (
                        <div className="bg-gradient-to-r from-purple-50 to-indigo-50 rounded-xl p-3 mb-4 border border-purple-100">
                          <div className="flex items-center gap-1.5 text-xs font-extrabold text-purple-700 mb-1">🏆 Notable Work</div>
                      ...
                      <div className="flex items-center justify-between mb-4">
                        ...
                        {expertSource === 'gemini_ai' && (
                          <span className="px-2 py-0.5 bg-purple-50 text-purple-600 rounded-full text-xs font-bold border border-purple-200">🤖 AI Verified</span>
                        )}
                      </div>
